...
$(document).ready(function() {
  ...
  function openNav() {
	...
	document.getElementById("grid").style.marginLeft = "320px";
	...
	$('.colors-large a').click(function(){return false;});
	  ...
	  $('.add-cart-large').each(function(i, el){
		  $(el).click(function(){
			  ...
			  $(".storefinal1").append('<div class="floating-cart"></div>');		
			  var cart = $('div.floating-cart');		
			  $("<img src='"+img.src+"' class='floating-image-large' />").appendTo(cart);
			  
			  $(cart).css({'top' : position.top + 'px', "left" : position.left + 'px'}).fadeIn("slow").addClass('moveToCart');		
			  setTimeout(function(){$(".storefinal1").addClass("MakeFloatingCart");}, 800);
			  
			  setTimeout(function(){
			  $('div.floating-cart').remove();
			  $(".storefinal1").removeClass("MakeFloatingCart");
